...
@ctrl_wrapper
async def update_avatar_controller(user: dict, source_path: str, db: AsyncSession, required: bool = True):
    """
    ...
    upload_avatar_url = await update_avatar_service(user["id"], source_path, db)
