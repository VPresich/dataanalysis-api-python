...
from app.controllers.users import get_current_controller, update_theme_controller
...
async def themes(data: ThemeValidation, current_user: dict = Depends(authenticate)):
